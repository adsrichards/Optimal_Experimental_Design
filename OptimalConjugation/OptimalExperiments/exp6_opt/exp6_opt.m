...
%------ PLOTTING ------%
si_opt = [15, 24, 29, 31, 39, 40]; % Optimal sampling intervals (shaded region)
...
% output sensitivities
dlmwrite('sensitivities6.txt', xso, 'delimiter', ' ', 'precision', 6)
...
function plottingStates(x,si_opt)
    ...
    ylabel(' ')
    title('Optimal Experiment #6','FontSize',24)
    axis([tmin-12 tmax 4 9.2]);
