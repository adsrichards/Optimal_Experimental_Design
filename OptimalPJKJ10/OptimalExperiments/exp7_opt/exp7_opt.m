...
%------ PLOTTING ------%
si_opt = [15, 20, 31, 32, 39, 40]; % Optimal sampling intervals (shaded region)
...
% output sensitivities
dlmwrite('sensitivities7.txt', xso, 'delimiter', ' ', 'precision', 6)
...
function plottingStates(x,si_opt)
    ...
    title('Optimal Experiment #7','FontSize',24)
