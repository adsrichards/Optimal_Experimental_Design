...
%------ PLOTTING ------%
si_opt = [14, 23, 32, 33, 39, 40]; % Optimal sampling intervals (shaded region)
...
% output sensitivities
dlmwrite('sensitivities4.txt', xso, 'delimiter', ' ', 'precision', 6)
...
function plottingStates(x,si_opt)
    ...
    ylabel(' ');
    title('Optimal Experiment #4','FontSize',24)
