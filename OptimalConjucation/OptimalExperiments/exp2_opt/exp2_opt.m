...
% output sensitivities
dlmwrite('sensitivities2.txt', xso, 'delimiter', ' ', 'precision', 6)
...
function plottingStates(x)
    ...
    ylabel(' ')
    title('Optimal Experiment #2','FontSize',24)
    ...
    si_opt = [12, 20, 31, 32, 39, 40]; % Optimal sampling intervals (shaded region)
    for mi=1:6
