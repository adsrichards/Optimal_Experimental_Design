...
%------ PLOTTING ------%
si_opt = [20, 30, 36, 37, 39, 40]; % Optimal sampling intervals (shaded region)
...
% output sensitivities
dlmwrite('sensitivities8.txt', xso, 'delimiter', ' ', 'precision', 6)
...
function plottingStates(x,si_opt)
    ...
    ylabel(' ')
    title('Optimal Experiment #8','FontSize',24)
