...
%------ PLOTTING ------%
si_opt = [15, 24, 33, 34, 39, 40]; % Optimal sampling intervals (shaded region)
...
% output sensitivities
dlmwrite('sensitivities5.txt', xso, 'delimiter', ' ', 'precision', 6)
...
function plottingStates(x,si_opt)
    ...
    title('Optimal Experiment #5','FontSize',24)
